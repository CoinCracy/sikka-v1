...
const FanCoinPage = ({
    ...
    return (
        <>
        <form name="fanCoin" method="POST" data-netlify="true" action="/app">
            ...
            <button  className = "p-2 mb-30 rounded-md shadow-lg bg-indigo-500 hover:shadow-xl duration-300 hover:bg-indigo-600" type="submit">Create Fancoin</button>
        </form>
        </>
    )
